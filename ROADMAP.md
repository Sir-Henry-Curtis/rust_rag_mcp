...
**See also:** [README.md](README.md), [docs/understanding-rag.md](docs/understanding-rag.md), [rust-rag-mcp-design-roadmap.md](rust-rag-mcp-design-roadmap.md) (architecture rationale).
