...
**See also:** [README.md](README.md), [docs/understanding-rag.md](docs/understanding-rag.md), [docs/using-rag-in-larger-systems.md](docs/using-rag-in-larger-systems.md), [docs/vectorstore-backend-comparison.md](docs/vectorstore-backend-comparison.md), [docs/multimodal-indexing-design.md](docs/multimodal-indexing-design.md), [docs/query-rewriting-and-conversation-retrieval.md](docs/query-rewriting-and-conversation-retrieval.md), [docs/federated-search-design.md](docs/federated-search-design.md), [rust-rag-mcp-design-roadmap.md](rust-rag-mcp-design-roadmap.md) (architecture rationale).
